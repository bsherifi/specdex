...
const SIDEBAR_STORAGE_KEY = "specdex:sidebar"
...
>(
  (
    ...
    // Uncontrolled open state, persisted to localStorage (client-only app —
    // no SSR cookie to read back, unlike upstream shadcn).
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Sizing gap that the fixed sidebar slots into. */}
        <div
          className={cn(
